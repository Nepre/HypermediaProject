...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 12, 2019 at 10:39 AM
...
INSERT INTO `books` (`id`, `title`, `author`, `genre`, `theme`, `date`, `price`, `description`, `image`, `available`) VALUES
...
(8, 'Don Quixote', 'Miguel de Cervantes', 'Novel', '', '1605', '9', 'Widely regarded as one of the funniest and most tragic books ever written, Don Quixote chronicles the adventures of the self-created knight-errant Don Quixote of La Mancha and his faithful squire, Sancho Panza, as they travel through sixteenth-century Spain.', 'Don_Quixote.jpg', 1),
